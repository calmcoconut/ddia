...
const QUIZ_QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      "A secondary index that is automatically kept synchronized with the primary index so it avoids the overhead of a separate heap file lookup on every query.",
  ...
  },
  {
    ...
    options: [
      "B-trees require spatial coordinates to be flattened into a single composite key using a space-filling curve, which loses the ability to represent arbitrary bounding box shapes.",
      ...
      "B-trees struggle with the high write workloads generated by active mobile clients updating their GPS coordinates in real-time database applications."
    ],
    correct: 1,

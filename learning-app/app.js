...
const QUIZ_QUESTIONS = [
  ...
  },
  {
    ...
    correct: 2,
    explanation: "Atmospheric simulation requires executing complex mathematical models (millions of floating-point operations) on a fixed set of boundary conditions, bottlenecked by CPU/GPU computation rather than I/O or data volume management.",
    section: "Introduction"
  },
  {
    type: "write",
...
function goToScenario(idx) {
  ...
  document.querySelector(`.scenario-card[data-scenario="${idx}"]`).classList.add('active');
